...
?>
		<hr>
		<div class="show" id="<?php echo $row1['ISBN']?>" align="left" onclick="window.location.href = '../booklayout/guestbooklayout.php?isbn=' + this.id;" >
			<div class="row">
				<div class="col-md-3">
		...
		<?php
					...
					echo "<hr><a href='../Browse/guestbrowse.php?search=".$search."&radio_group1=all&filter=none' style='float:right'>see all</a>";
				}
			}
		}
?>
